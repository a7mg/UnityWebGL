...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'ExportMiniDev.data';
    var REMOTE_PACKAGE_BASE = 'ExportMiniDev.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2678638;
      var PACKAGE_UUID = 'e017d2bb-a373-4872-9f11-c63eb483535a';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 332175, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(332175, 332194, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(332194, 332317, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(332317, 1776041, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1776041, 2651013, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2651013, 2678638, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_ExportMiniDev.data');

    };
    Module['addRunDependency']('datafile_ExportMiniDev.data');
